...
STATIC_ROOT = str(BASE_DIR / "backend" / "project" / "public")
...
# EMAIL_TIMEOUT = 5
EMAIL_ACTIVE_FIELD = env("EMAIL_ACTIVE_FIELD", default="is_active")
EMAIL_SERVER = env("EMAIL_SERVER", default="smtp.gmail.com")
EMAIL_PORT = env("EMAIL_PORT", cast=int, default=587)
EMAIL_ADDRESS = env("EMAIL_ADDRESS", default="")
EMAIL_FROM_ADDRESS = env("EMAIL_FROM_ADDRESS", default="")
EMAIL_PASSWORD = env("EMAIL_PASSWORD", default="")
EMAIL_MAIL_SUBJECT = env("EMAIL_MAIL_SUBJECT", default="Confirm your email")
EMAIL_MAIL_HTML = env("EMAIL_MAIL_HTML", default="")
EMAIL_MAIL_PLAIN = env("EMAIL_MAIL_PLAIN", default="")
EMAIL_PAGE_TEMPLATE = env("EMAIL_PAGE_TEMPLATE", default="")
EMAIL_PAGE_DOMAIN = env("EMAIL_PAGE_DOMAIN", default="http://localhost:8000/")
...
DRF_RECAPTCHA_SECRET_KEY = env("RECAPTCHA_PRIVATE_KEY", default="")
